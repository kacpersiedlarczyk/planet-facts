export default function addEarth() {
    ...
    rotationParagraph.innerText = "23 hours and 56 minutes";
    ...
    revolutionParagraph.innerText = "365 Days";
    ...
    radiusParagraph.innerText = "6371 km";
    ...
    averageTemperatureParagraph.innerText = "15°C";
};